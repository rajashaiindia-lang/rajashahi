...
"[project]/.next-internal/server/app/api/result/closing/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/result/closing/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!isAdmin) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Unauthorized'
    }, {
        status: 401
    });
    ...
    if (!/^\d{3}$/.test(closingPanna || '')) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'closingPanna must be a 3-digit string'
        }, {
            status: 400
        });
    }
    ...
    if (round.closingDigit !== undefined) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Closing already published'
        }, {
            status: 400
        });
    }
    if (round.openingDigit === undefined) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Opening not published yet'
        }, {
            status: 400
        });
    }
    round.closingPanna = closingPanna;
    round.closingDigit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["digitFromPanna"])(closingPanna);
    round.jodi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deriveJodi"])(round.openingDigit, round.closingDigit);
    round.status = 'CLOSED';
    await round.save();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        round
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c387f71._.js.map